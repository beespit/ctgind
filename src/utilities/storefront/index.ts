...
export const publicStorefrontToken = process.env.SHOPIFY_STOREFRONT_API_TOKEN!;
export const storefrontApiVersion = process.env.SHOPIFY_STOREFRONT_API_VERSION!;
